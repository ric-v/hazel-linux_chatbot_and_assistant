...
def useracnt():
	print("\033[1;34;1m")
	uname = raw_input("Hazel : Set a new username for this user : ")
...
def adminacnt():
	print("\033[1;34;1m")
	uname = raw_input("Hazel : Set a new username for the admin account : ")
...
def useacnt():
	print("\033[1;34;1m")
	uname = raw_input("Hazel : Type the user name you want to delete : ")
